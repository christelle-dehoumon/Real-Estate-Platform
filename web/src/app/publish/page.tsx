            ...
            <div className="lg:col-span-2 space-y-10">
              <div className="border border-border shadow-md overflow-hidden hover:grayscale-0 transition-all duration-1000 group relative rounded-2xl">
                <iframe
                  ...
                  frameBorder="0"
                  scrolling="no"
                  src={`https://maps.google.com/maps?width=100%25&height=450&hl=fr&q=${formData.city || 'Ouagadougou'},Burkina%20Faso+(Fasohabitat%20Location)&t=&z=14&ie=UTF8&iwloc=B&output=embed`}
